...
class TrackballWild(TrackballOrbyl):
        ...
        hulls.append(
            triangle_hulls(
                [
                    ...
                    self.tl_place(web_post_br(wide=self.tl_off)),
                    self.track_place(self.tb_post_r()),
                    self.tl_place(web_post_bl(wide=self.tl_off)),
        ...
        hulls.append(
            triangle_hulls(
                [
                    ...
                    self.tl_place(web_post_tr(wide=self.tl_off)),
                ]
            )
        )
    ...
    def connection(self, side='right'):
        ...
        # ======= These three account for offset between plate and wall methods
        hulls.append(
            triangle_hulls(
                [
                    self.tl_place(web_post_tl()),
                    self.tl_place(web_post_tl(wide=self.tl_off)),
                    self.tl_place(web_post_tr(wide=self.tl_off)),
        ...
        hulls.append(
            triangle_hulls(
                [
                    ...
                    self.tl_place(web_post_bl(wide=self.tl_off)),  # top cluster key, bottom left (sort of top left)
        ...
        hulls.append(
            triangle_hulls(
                [
                    ...
                    self.tl_place(web_post_tr(wide=self.tl_off)),  # col 2 bottom, bottom left corner
                    self.tl_place(web_post_tl(wide=self.tl_off))
                ]
            )
        )
